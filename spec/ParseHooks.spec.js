...
describe('Hooks', () => {
  ...
  it_exclude_dbs(['oracle'])('should CRUD a function registration', done => {
    // Create
  ...
  it_exclude_dbs(['oracle'])('should CRUD a trigger registration', done => {
    // Create
  ...
  it_exclude_dbs(['oracle'])('should fail trying to create two times the same function', done => {
  ...
  it_exclude_dbs(['oracle'])('should fail trying to create two times the same trigger', done => {
  ...
  it_exclude_dbs(['oracle'])('should create hooks and properly preload them', done => {
    const promises = [];
    for (let i = 0; i < 5; i++) {
      promises.push(
  ...
  it_exclude_dbs(['oracle'])('should run the function on the test server', done => {
  ...
  it_exclude_dbs(['oracle'])('should provide X-Parse-Webhook-Key when defined', done => {
  ...
  it_exclude_dbs(['oracle'])('should not pass X-Parse-Webhook-Key if not provided', done => {
  ...
  it_exclude_dbs(['oracle'])('should run the beforeSave hook on the test server', done => {
    let triggerCount = 0;
  ...
  it_exclude_dbs(['oracle'])('should run the afterSave hook on the test server', done => {
    let triggerCount = 0;
    let newObjectId;

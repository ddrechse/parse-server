...
describe('Cloud Code Logger', () => {
  ...
  it_id('0ab8bca4-b20e-4ec2-8a51-1211f677ab64')('trigger should obfuscate password', done => {
  ...
  it_id('bd1aabdf-d1ff-43a0-b8ee-2bf7de1ecf92')(
    'should log cloud function triggers using the custom log level',
    async () => {
